    ...
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="flex items-center justify-between px-4 pt-4 pb-3 sm:px-6 sm:pt-8 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 flex-1 sm:flex-none">
          ...
          <button onClick={()=>setShowCats(true)}
            className={`flex items-center gap-2 text-sm px-4 py-2 rounded-xl border transition-all flex-shrink-0 ${showCats||genre!=="all" ? "bg-violet-600 border-violet-600 text-white" : "bg-zinc-900 border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-600"}`}>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6 overflow-x-hidden">
        {loading?(
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 sm:gap-4 p-1">
