                ...
                <div key={ch.stream_id} onClick={()=>openChannel(ch)}
                  ...
                  <div className="h-24 flex items-center justify-center relative bg-zinc-900">
                    {isLocked ? (
                      ...
                      <img src={ch.stream_icon?.startsWith("http://") ? `https://iptv-manager--luizdori.replit.app/api/xtream/stream?url=${encodeURIComponent(ch.stream_icon)}` : ch.stream_icon} alt={ch.name} className="w-20 h-14 object-contain"
